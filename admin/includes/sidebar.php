...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="rentabilidad.php" <?php echo $currentPage === 'rentabilidad.php' ? 'class="active"' : ''; ?>><span class="icon"><?php echo $icons['rentabilidad']; ?></span><span class="menu-text">Rentabilidad</span></a></li>
