...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="comunicados.php" <?php echo $currentPage === 'comunicados.php' ? 'class="active"' : ''; ?>><span class="icon"><?php echo $icons['mensajes']; ?></span><span class="menu-text">Comunicados</span></a></li>
