<?php
/**
 * InverCar - Admin Sidebar Component - Diseño Premium
 */
...
$icons = [
    ...
    'rentabilidad' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></svg>',
...
<aside class="sidebar">
    <div class="sidebar-logo">
        <img src="../assets/images/logo-invercar-text.png" alt="InverCar">
    </div>

    <ul class="sidebar-menu">
        <li><a href="index.php" <?php echo $currentPage === 'index.php' ? 'class="active"' : ''; ?>><span class="icon"><?php echo $icons['dashboard']; ?></span> Dashboard</a></li>
        ...
        <li><a href="rentabilidad.php" <?php echo $currentPage === 'rentabilidad.php' ? 'class="active"' : ''; ?>><span class="icon"><?php echo $icons['rentabilidad']; ?></span> Rentabilidad</a></li>

        <li class="sidebar-section">Sistema</li>
        <li><a href="contactos.php" <?php echo $currentPage === 'contactos.php' ? 'class="active"' : ''; ?>><span class="icon"><?php echo $icons['mensajes']; ?></span> Mensajes <?php if($mensajesNoLeidos > 0): ?><span class="badge badge-danger" style="margin-left: auto; padding: 2px 8px; font-size: 0.7rem;"><?php echo $mensajesNoLeidos; ?></span><?php endif; ?></a></li>
        <li><a href="configuracion.php" <?php echo $currentPage === 'configuracion.php' ? 'class="active"' : ''; ?>><span class="icon"><?php echo $icons['config']; ?></span> Configuración</a></li>
    </ul>

    <div class="sidebar-footer">
        <a href="logout.php" class="btn btn-outline" style="width: 100%; text-align: center; display: flex; align-items: center; justify-content: center; gap: 8px;">
            <?php echo $icons['logout']; ?> Cerrar Sesión
        </a>
    </div>
</aside>
