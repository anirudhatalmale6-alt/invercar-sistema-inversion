...
switch ($ordenar) {
    case 'dias_venta_creciente':
        ...
        $orderByClause = "DATEDIFF(NOW(), fecha_compra) ASC, fecha_compra DESC";
        break;
    case 'dias_venta_decreciente':
        // De más días a menos días (los que llevan más tiempo primero)
        $orderByClause = "DATEDIFF(NOW(), fecha_compra) DESC, fecha_compra DESC";
        break;
    case 'venta_alta':
    ...
    case 'fecha_compra':
    default:
        $orderByClause = "fecha_compra DESC, created_at DESC";
        break;
}
        ...
        <main class="main-content">
            ...
            <div class="dashboard-layout" style="grid-template-columns: 1fr 300px;">
                ...
                <div class="dashboard-main">
                    ...
                    <!-- Fichas de Vehículos -->
                    <div style="margin-top: 8px; display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px; flex-wrap: wrap; gap: 10px;">
                        <div class="section-title" style="margin: 0;">Vehículos</div>
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <select id="ordenar" onchange="window.location.href='?filtro_estado=<?php echo $filtroEstado; ?>&ordenar=' + this.value" style="padding: 8px 12px; background: var(--card-bg); border: 1px solid var(--border-color); color: var(--text-light); font-size: 0.85rem;">
                    ...
                    <?php else: ?>
                        <div class="vehicle-grid">
                            <?php foreach ($vehiculosActivos as $vehiculo):
                                // Calcular rentabilidad: Venta prevista - (Compra + Prevision de Gastos)
                                $prevGastos = floatval($vehiculo['prevision_gastos'] ?? 0);
                                $costeTotal = floatval($vehiculo['precio_compra']) + $prevGastos;
